...
public sealed class FakeChatClient : IChatClient
{
    ...
    public FakeChatClient WithResponse(
        ...
        WithResponse((IReadOnlyList<AIContent>)contents, finishReason, usage, modelId);
    ...
    {
        ChatResponse response = new(new ChatMessage(ChatRole.Assistant, [.. prepared.Contents]))
        {
