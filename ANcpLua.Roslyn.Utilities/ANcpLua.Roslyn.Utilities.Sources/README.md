...
Source-only version of [ANcpLua.Roslyn.Utilities](https://www.nuget.org/packages/ANcpLua.Roslyn.Utilities) for embedding
in source generators and analyzers.
...
Source generators and analyzers run inside the Roslyn compiler process, which **cannot load NuGet runtime dependencies
**. The utilities must be embedded as source code that compiles directly into your analyzer/generator assembly.
