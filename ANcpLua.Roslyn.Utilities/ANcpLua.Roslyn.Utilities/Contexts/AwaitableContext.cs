...
/// <remarks>
/// <list type="bullet">
///   <item>Supports <see cref="System.Threading.Tasks.Task"/>, <see cref="System.Threading.Tasks.Task{TResult}"/>,
///         <see cref="System.Threading.Tasks.ValueTask"/>, and <see cref="System.Threading.Tasks.ValueTask{TResult}"/>.</item>
...
sealed class AwaitableContext
{
    ...
    /// <summary>
    /// Gets the <see cref="System.Threading.Tasks.Task{TResult}"/> generic type definition, or <c>null</c> if not available.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="System.Threading.Tasks.ValueTask{TResult}"/> generic type definition, or <c>null</c> if not available.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="System.Runtime.CompilerServices.INotifyCompletion"/> interface type symbol, or <c>null</c> if not available.
    /// </summary>
    public INamedTypeSymbol? INotifyCompletion { get; }

    /// <summary>
    /// Gets the <see cref="System.Runtime.CompilerServices.ICriticalNotifyCompletion"/> interface type symbol, or <c>null</c> if not available.
    /// </summary>
    public INamedTypeSymbol? ICriticalNotifyCompletion { get; }

    /// <summary>
    /// Gets the <see cref="System.Runtime.CompilerServices.AsyncMethodBuilderAttribute"/> type symbol, or <c>null</c> if not available.
    /// </summary>
    public INamedTypeSymbol? AsyncMethodBuilderAttribute { get; }

    /// <summary>
    /// Gets the <see cref="System.Runtime.CompilerServices.ConfiguredTaskAwaitable"/> type symbol, or <c>null</c> if not available.
    /// </summary>
    public INamedTypeSymbol? ConfiguredTaskAwaitable { get; }

    /// <summary>
    /// Gets the <see cref="System.Runtime.CompilerServices.ConfiguredValueTaskAwaitable"/> type symbol, or <c>null</c> if not available.
    /// </summary>
