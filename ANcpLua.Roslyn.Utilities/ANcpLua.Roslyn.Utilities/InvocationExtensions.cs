...
/// <summary>
/// Provides extension methods for working with <see cref="IInvocationOperation"/> and <see cref="IObjectCreationOperation"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <list type="bullet">
/// <item><description>Retrieve arguments by name or index from invocations and object creations</description></item>
/// <item><description>Extract constant argument values with type-safe conversion</description></item>
/// <item><description>Identify method characteristics such as LINQ methods, async methods, and extension methods</description></item>
/// <item><description>Analyze receiver types and cancellation token usage</description></item>
/// </list>
/// </remarks>
...
static class InvocationExtensions
{
    ...
    /// <summary>
    /// Determines whether the invocation is a LINQ method from <c>System.Linq.Enumerable</c> or <c>System.Linq.Queryable</c>.
    /// </summary>
    /// <param name="operation">The invocation operation to examine.</param>
    /// <returns>
