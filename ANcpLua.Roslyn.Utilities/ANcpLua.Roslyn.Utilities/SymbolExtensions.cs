...
///     </para>
///     <list type="bullet">
///         <item><description>Symbol comparison using <see cref="SymbolEqualityComparer.Default"/></description></item>
///         <item><description>Attribute lookup by name or type symbol with optional inheritance</description></item>
///         <item><description>Accessibility and visibility checks</description></item>
///         <item><description>Member traversal including inherited members</description></item>
///         <item><description>Type parameter and type argument retrieval</description></item>
///         <item><description>Interface implementation detection</description></item>
///     </list>
/// </remarks>
...
static class SymbolExtensions
{
    ...
    ///     <list type="bullet">
    ///         <item><description>For <see cref="IParameterSymbol"/>: the parameter type</description></item>
    ///         <item><description>For <see cref="IFieldSymbol"/>: the field type</description></item>
    ///         <item><description>For <see cref="IPropertySymbol"/> with a getter: the property type</description></item>
    ///         <item><description>For <see cref="ILocalSymbol"/>: the local variable type</description></item>
    ///         <item><description>For <see cref="IMethodSymbol"/>: the return type</description></item>
    ///         <item><description>For other symbols: <c>null</c></description></item>
    ///     </list>
    /// </returns>
    ...
    ///     <list type="bullet">
    ///         <item><description>For <see cref="IMethodSymbol"/>: <see cref="IMethodSymbol.OverriddenMethod"/></description></item>
    ///         <item><description>For <see cref="IPropertySymbol"/>: <see cref="IPropertySymbol.OverriddenProperty"/></description></item>
    ///         <item><description>For <see cref="IEventSymbol"/>: <see cref="IEventSymbol.OverriddenEvent"/></description></item>
    ///         <item><description>For other symbols: <c>null</c></description></item>
    ///     </list>
    /// </returns>
