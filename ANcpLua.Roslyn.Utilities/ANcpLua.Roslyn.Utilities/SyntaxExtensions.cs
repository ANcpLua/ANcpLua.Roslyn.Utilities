...
///     </para>
///     <list type="bullet">
///         <item><description>Extract method and identifier names from expressions</description></item>
///         <item><description>Check for specific modifiers on member declarations</description></item>
///         <item><description>Detect partial types and primary constructor types</description></item>
///         <item><description>Retrieve name token locations for diagnostics</description></item>
///     </list>
/// </remarks>
...
static class SyntaxExtensions
{
    ...
    ///     </para>
    ///     <list type="bullet">
    ///         <item><description>For member access expressions, returns the name portion (e.g., "Method" from "obj.Method")</description></item>
    ///         <item><description>For identifier expressions, returns the identifier text directly</description></item>
    ///         <item><description>For other expression types, returns <c>null</c></description></item>
    ///     </list>
    /// </remarks>
    ...
    ///     </para>
    ///     <list type="bullet">
    ///         <item><description>For identifier expressions (e.g., <c>foo</c>), returns the identifier text</description></item>
    ///         <item><description>For member access expressions (e.g., <c>obj.Property</c>), returns the member name</description></item>
    ///         <item><description>For other expression types, returns <c>null</c></description></item>
    ///     </list>
    /// </remarks>
    ...
    ///     </para>
    ///     <list type="bullet">
    ///         <item><description>Applies to <see cref="ClassDeclarationSyntax"/>, <see cref="StructDeclarationSyntax"/>, and <see cref="RecordDeclarationSyntax"/></description></item>
    ///         <item><description>Returns <c>true</c> only if the type has a non-null <see cref="TypeDeclarationSyntax.ParameterList"/></description></item>
    ///         <item><description>Does not apply to interfaces or other type declarations</description></item>
    ///     </list>
    /// </remarks>
    /// <seealso cref="IsPartial"/>
