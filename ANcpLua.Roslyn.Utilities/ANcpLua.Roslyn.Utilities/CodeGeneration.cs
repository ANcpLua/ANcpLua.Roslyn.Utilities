...
/// <remarks>
/// <list type="bullet">
/// <item><description>All generated strings use fully-qualified type names with <c>global::</c> prefix to avoid namespace conflicts.</description></item>
/// <item><description>Methods are designed for use in Roslyn incremental source generators.</description></item>
/// <item><description>String interpolation is used for efficient code generation.</description></item>
/// </list>
/// </remarks>
...
static class GeneratedCodeHelpers
{
    ...
    /// <returns>
    /// A string containing the fully-qualified <see cref="System.CodeDom.Compiler.GeneratedCodeAttribute"/> with the specified tool name and version.
    /// </returns>
    ...
    /// <summary>
    /// Gets the <see cref="System.ComponentModel.EditorBrowsableAttribute"/> with <see cref="System.ComponentModel.EditorBrowsableState.Never"/>.
    /// <para>
    ...
    /// <returns>
    /// A string containing the pragma directive, or <see cref="string.Empty"/> if <paramref name="warningIds"/> is empty.
    /// </returns>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>All <c>Append</c> and <c>AppendLine</c> methods automatically prepend the current indentation.</description></item>
/// <item><description>Use <see cref="BeginBlock"/> with a <c>using</c> statement for automatic block closure.</description></item>
/// <item><description>The builder is reusable via the <see cref="Clear"/> method.</description></item>
/// </list>
/// </remarks>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>Created by <see cref="IndentedStringBuilder.BeginBlock"/> and related methods.</description></item>
/// <item><description>Calls <see cref="IndentedStringBuilder.EndBlock"/> when disposed.</description></item>
/// <item><description>Implemented as a <c>readonly struct</c> for zero-allocation usage.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="IndentedStringBuilder"/>
#if ANCPLUA_ROSLYN_PUBLIC
