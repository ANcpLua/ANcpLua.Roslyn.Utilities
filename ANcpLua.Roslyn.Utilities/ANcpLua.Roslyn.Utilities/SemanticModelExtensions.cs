...
public static class SemanticModelExtensions
{
    ...
    /// </summary>
    public static bool IsConstant(this SemanticModel model, SyntaxNode node, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    public static bool AllConstant(this SemanticModel model, IEnumerable<SyntaxNode> nodes, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    public static T? GetConstantValueOrDefault<T>(this SemanticModel model, SyntaxNode node, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    public static bool IsNullConstant(this SemanticModel model, SyntaxNode node, CancellationToken cancellationToken = default)
    {
        var optional = model.GetConstantValue(node, cancellationToken);
