...
/// </para>
/// <list type="bullet">
///   <item><description>All predicates are combined with logical AND semantics.</description></item>
///   <item><description>The builder supports implicit conversion to <see cref="SymbolPattern{T}"/>.</description></item>
///   <item><description>Predicates are evaluated in the order they were added.</description></item>
/// </list>
/// </remarks>
...
sealed class ParameterPatternBuilder
{
    ...
    /// </summary>
    /// <param name="fullyQualifiedName">The fully qualified name of the attribute (e.g., <c>"System.ComponentModel.DescriptionAttribute"</c>).</param>
    /// <returns>This builder instance for method chaining.</returns>
