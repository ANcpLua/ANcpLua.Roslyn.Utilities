...
/// </para>
/// <list type="bullet">
/// <item><description>Name matching: <see cref="Named"/>, <see cref="NameStartsWith"/>, <see cref="NameEndsWith"/>, <see cref="NameMatches"/></description></item>
/// <item><description>Modifiers: <see cref="Static"/>, <see cref="Instance"/>, <see cref="Async"/>, <see cref="Virtual"/>, <see cref="Abstract"/>, <see cref="Sealed"/>, <see cref="Override"/></description></item>
/// <item><description>Accessibility: <see cref="Public"/>, <see cref="Private"/>, <see cref="Protected"/>, <see cref="Internal"/></description></item>
/// <item><description>Return types: <see cref="ReturnsVoid"/>, <see cref="Returns(ITypeSymbol)"/>, <see cref="ReturnsString"/>, <see cref="ReturnsBool"/>, <see cref="ReturnsInt"/>, <see cref="ReturnsTask"/></description></item>
/// <item><description>Parameters: <see cref="NoParameters"/>, <see cref="ParameterCount"/>, <see cref="WithParameter(Func{IParameterSymbol, bool})"/>, <see cref="WithCancellationToken"/></description></item>
/// <item><description>Type parameters: <see cref="NoTypeParameters"/>, <see cref="TypeParameterCount"/></description></item>
/// <item><description>Method kind: <see cref="IsExtensionMethod"/>, <see cref="IsConstructor"/>, <see cref="IsOrdinaryMethod"/>, <see cref="IsOperator"/>, <see cref="IsPropertyAccessor"/></description></item>
/// <item><description>Context: <see cref="InType(Func{INamedTypeSymbol, bool})"/>, <see cref="InNamespace"/>, <see cref="HasAttribute(string)"/>, <see cref="ImplementsInterface"/></description></item>
/// </list>
/// </remarks>
/// <example>
/// <code>
...
sealed class MethodPatternBuilder
{
    ...
    /// <summary>
    /// Adds a predicate requiring the method to have at least one parameter matching the specified <paramref name="predicate"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds a predicate requiring the parameter at the specified <paramref name="index"/> to match the specified <paramref name="predicate"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds a predicate requiring the method to have at least one <see cref="System.Threading.CancellationToken"/> parameter.
    /// </summary>
    /// <returns>This builder instance for method chaining.</returns>
    /// <seealso cref="Async"/>
    /// <seealso cref="ReturnsTask"/>
