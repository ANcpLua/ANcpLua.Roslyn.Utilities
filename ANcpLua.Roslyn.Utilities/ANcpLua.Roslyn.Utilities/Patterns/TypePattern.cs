...
///     <list type="bullet">
///         <item>
///             <description>All filter methods return <c>this</c> to enable method chaining.</description>
///         </item>
///         <item>
///             <description>Multiple criteria are combined with logical AND semantics.</description>
///         </item>
///         <item>
///             <description>Use <see cref="Build" /> to create the final pattern, or rely on implicit conversion.</description>
///         </item>
///         <item>
///             <description>Patterns are immutable once built and safe for caching.</description>
///         </item>
///     </list>
/// </remarks>
/// <example>
    ...
    sealed class TypePatternBuilder
{
    ...
    {
        _predicates.Add(t =>
            t.ContainingNamespace?.ToDisplayString().StartsWith(prefix, StringComparison.Ordinal) == true);
        return this;
    }
