...
///     </para>
///     <list type="bullet">
///         <item><description>Use <see cref="Method()"/> to create a matcher without initial constraints.</description></item>
///         <item><description>Use <see cref="Method(string)"/> to create a matcher targeting a specific method name.</description></item>
///     </list>
/// </remarks>
...
///     </para>
///     <list type="bullet">
///         <item><description>Chain method calls to build complex matching criteria.</description></item>
///         <item><description>Use <see cref="Matches(IInvocationOperation?)"/> to test invocations.</description></item>
///         <item><description>Use <see cref="Where(Func{IInvocationOperation, bool})"/> for custom conditions.</description></item>
///     </list>
/// </remarks>
/// <example>
///     <code>
