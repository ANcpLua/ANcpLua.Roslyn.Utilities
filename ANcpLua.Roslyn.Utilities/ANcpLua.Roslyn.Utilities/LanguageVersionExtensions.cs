...
///     </para>
///     <list type="bullet">
///         <item><description>Uses numeric comparison against internal language version values for forward compatibility.</description></item>
///         <item><description>Each method returns <c>true</c> if the version is at least the specified version or higher.</description></item>
///         <item><description>Works with both explicit versions and <see cref="LanguageVersion.Latest" /> / <see cref="LanguageVersion.Preview" />.</description></item>
///     </list>
/// </remarks>
...
static class LanguageVersionExtensions
{
    ...
    public static bool IsCSharp12OrAbove(this LanguageVersion languageVersion) =>
        languageVersion >= (LanguageVersion)1200;
    ...
    public static bool IsCSharp13OrAbove(this LanguageVersion languageVersion) =>
        languageVersion >= (LanguageVersion)1300;
    ...
    public static bool IsCSharp14OrAbove(this LanguageVersion languageVersion) =>
        languageVersion >= (LanguageVersion)1400;
}
