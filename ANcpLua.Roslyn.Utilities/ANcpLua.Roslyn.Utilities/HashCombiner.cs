...
/// </para>
/// <list type="bullet">
/// <item><description>This is a mutable struct for performance; use it within a single method scope only.</description></item>
/// <item><description>Do not store or pass instances across method boundaries as the state may be copied unexpectedly.</description></item>
/// <item><description>Use <see cref="Create"/> to initialize a new instance, then call <see cref="Add(int)"/> or overloads to combine values.</description></item>
/// <item><description>Retrieve the final hash via <see cref="HashCode"/> or <see cref="ToHashCode"/>.</description></item>
/// </list>
/// </remarks>
...
/// </para>
/// <list type="bullet">
/// <item><description>Use <see cref="ToEquatableArray{T}(IEnumerable{T})"/> to wrap sequences for value equality.</description></item>
/// <item><description>Use <see cref="SequenceEquals{T}(ImmutableArray{T}, ImmutableArray{T})"/> for element-wise comparison.</description></item>
/// <item><description>Use <see cref="GetSequenceHashCode{T}"/> to compute a hash over all elements.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="EquatableArray{T}"/>
