...
/// <remarks>
///     <list type="bullet">
///         <item><description>All formatting methods produce consistent, human-readable output for test assertions.</description></item>
///         <item><description>List formatting uses bracket notation with comma separation, or "none" for empty collections.</description></item>
///         <item><description>Diagnostic formatting uses visual icons to distinguish errors from warnings.</description></item>
///     </list>
/// </remarks>
...
internal static class AssertionHelpers
{
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Projects each item using the selector before formatting.</description></item>
    ///         <item><description>Delegates to <see cref="FormatList(IEnumerable{string})"/> after projection.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Returns "none" for empty collections to clearly indicate absence of items.</description></item>
    ///         <item><description>Uses bracket notation for visual clarity in assertion messages.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Extracts the <see cref="GeneratedFile.HintName"/> from each file.</description></item>
    ///         <item><description>Useful for displaying which files were generated in assertion messages.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Removes duplicate IDs for cleaner output.</description></item>
    ///         <item><description>Useful for summarizing which diagnostic rules were triggered.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Uses a cross mark icon for errors and a warning icon for other severities.</description></item>
    ///         <item><description>Includes 1-based line and column numbers when the diagnostic has a source location.</description></item>
    ///         <item><description>Indents with two spaces for alignment in multi-line output.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Includes both errors and warnings with their respective icons.</description></item>
    ///         <item><description>Preserves the order of diagnostics from the input collection.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Filters to include only <see cref="DiagnosticSeverity.Error"/> diagnostics.</description></item>
    ///         <item><description>Uses simplified formatting without location information.</description></item>
    ///         <item><description>Useful when only compilation errors are relevant.</description></item>
    ///     </list>
    /// </remarks>
    /// <seealso cref="FormatDiagnosticList"/>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Each step is prefixed with a cross mark icon to indicate failure.</description></item>
    ///         <item><description>Includes the step's caching breakdown via <see cref="GeneratorStepAnalysisExtensions.FormatBreakdown"/>.</description></item>
    ///         <item><description>Useful for diagnosing which pipeline steps are not caching correctly.</description></item>
    ///     </list>
    /// </remarks>
    /// <seealso cref="GeneratorStepAnalysis"/>
    /// <seealso cref="StepFormatter"/>
...
/// <remarks>
///     <list type="bullet">
///         <item><description>Produces compact breakdown strings showing cached vs. modified counts.</description></item>
///         <item><description>Formats step lines with status icons and optional annotations.</description></item>
///         <item><description>Generates detailed issue reports for failed caching steps.</description></item>
///     </list>
/// </remarks>
/// <seealso cref="GeneratorStepAnalysis"/>
...
internal static class StepFormatter
{
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>C (Cached) and U (Unchanged) indicate successful caching.</description></item>
    ///         <item><description>M (Modified), N (New), and R (Removed) indicate cache invalidation.</description></item>
    ///         <item><description>The pipe separator visually distinguishes good outcomes from problematic ones.</description></item>
    ///     </list>
    /// </remarks>
    /// <seealso cref="GeneratorStepAnalysis"/>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Prefixes with "[OK]" for successfully cached steps or "[FAIL]" for failures.</description></item>
    ///         <item><description>Adds "[Tracked]" annotation for steps in the requiredSteps list.</description></item>
    ///         <item><description>Adds "[!]" annotation for steps with forbidden type violations.</description></item>
    ///         <item><description>Includes the full caching breakdown at the end of the line.</description></item>
    ///     </list>
    /// </remarks>
    ...
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>Includes a numbered header for easy reference in reports with multiple issues.</description></item>
    ///         <item><description>Shows the full caching breakdown for diagnostic purposes.</description></item>
    ///         <item><description>Provides cause analysis distinguishing forbidden types from equality issues.</description></item>
    ///         <item><description>Suggests appropriate fixes based on the detected cause.</description></item>
    ///     </list>
    /// </remarks>
    /// <seealso cref="FormatBreakdown"/>
    /// <seealso cref="GeneratorStepAnalysis.HasForbiddenTypes"/>
