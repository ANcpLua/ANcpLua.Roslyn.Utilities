...
///         <list type="bullet">
///             <item>
///                 <description>You have many tests for the same generator</description>
///             </item>
///             <item>
///                 <description>You want to avoid repeating the generic type parameter</description>
///             </item>
///             <item>
///                 <description>You prefer a more object-oriented testing style</description>
///             </item>
///         </list>
///     </para>
///     <para>
...
public sealed class GeneratorTester<TGenerator> where TGenerator : IIncrementalGenerator, new()
{
    ...
    /// <inheritdoc
    ///     cref="GeneratorTest.ShouldCacheWithCompilationUpdate{TGenerator}(string,Func{Compilation,Compilation},Action{CompilationCacheResult}?)" />
