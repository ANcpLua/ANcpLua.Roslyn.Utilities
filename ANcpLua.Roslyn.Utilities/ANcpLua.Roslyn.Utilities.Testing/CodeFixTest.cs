...
/// </para>
/// <list type="bullet">
/// <item><description>Pre-configuring reference assemblies for .NET 10 or .NET Standard 2.0</description></item>
/// <item><description>Normalizing line endings to ensure cross-platform test consistency</description></item>
/// <item><description>Integrating with the Microsoft.CodeAnalysis.Testing framework</description></item>
/// </list>
/// <para>
...
public abstract class CodeFixTest<TAnalyzer, TCodeFix>
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description><c>true</c> (default): Uses .NET 10 reference assemblies with full modern API surface</description></item>
    /// <item><description><c>false</c>: Uses .NET Standard 2.0 reference assemblies for testing cross-platform compatibility</description></item>
    /// </list>
    /// </param>
    /// <returns>
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description>Normalizes line endings in both source and fixed source for cross-platform consistency</description></item>
    /// <item><description>Creates a compilation with the appropriate reference assemblies</description></item>
    /// <item><description>Runs the analyzer to produce diagnostics at marked locations</description></item>
    /// <item><description>Applies the code fix and verifies the result matches <paramref name="fixedSource"/></description></item>
    /// </list>
    /// </remarks>
    /// <example>
    /// <para>
