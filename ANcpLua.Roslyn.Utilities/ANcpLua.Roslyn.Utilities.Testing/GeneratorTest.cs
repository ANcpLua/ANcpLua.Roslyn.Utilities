...
public static class GeneratorTest
{
    ...
    /// <param name="severity">
    /// Expected diagnostic severity. Defaults to <see cref="DiagnosticSeverity.Error"/>.
    /// </param>
    /// <param name="source">C# source code to compile and feed into the generator.</param>
    /// <returns>A task that completes when the assertion finishes.</returns>
    /// <example>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="ShouldCacheWithCompilationUpdate{TGenerator}(string,System.Func{Microsoft.CodeAnalysis.Compilation,Microsoft.CodeAnalysis.Compilation}(Microsoft.CodeAnalysis.Compilation),Action{CompilationCacheResult}?)"/>/>
    ...
    /// <see cref="GeneratorDriver.RunGeneratorsAndUpdateCompilation(Compilation,out Compilation,out System.Collections.Immutable.ImmutableArray{Diagnostic},System.Threading.CancellationToken)"/>,
    ...
    public static async Task ShouldCacheWithCompilationUpdate<TGenerator>(this string source, Func<Compilation, Compilation> makeChange,
