...
/// </para>
/// <list type="bullet">
/// <item><description>Supports both .NET 10 and .NET Standard 2.0 reference assemblies</description></item>
/// <item><description>Automatically configures global and project-level EditorConfig files</description></item>
/// <item><description>Supports additional source files for multi-file test scenarios</description></item>
/// <item><description>Handles line ending normalization for cross-platform compatibility</description></item>
/// </list>
/// </remarks>
...
public abstract class CodeFixTestWithEditorConfig<TAnalyzer, TCodeFix>
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description>Reference assemblies for the specified target framework</description></item>
    /// <item><description>EditorConfig files (both global and project-level)</description></item>
    /// <item><description>Additional source files for multi-file scenarios</description></item>
    /// </list>
    /// <para>
    /// The test verifies that:
    /// </para>
    /// <list type="bullet">
    /// <item><description>The analyzer produces diagnostics at the marked locations in the source</description></item>
    /// <item><description>The code fix transforms the source to match the expected fixed source</description></item>
    /// <item><description>No additional diagnostics are produced after the fix is applied</description></item>
    /// </list>
    /// </remarks>
    /// <param name="source">
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description>Configurable reference assemblies (NET 10 or .NET Standard 2.0)</description></item>
    /// <item><description>EditorConfig file generation from key-value pairs</description></item>
    /// <item><description>Support for multi-file test scenarios</description></item>
    /// </list>
    /// </remarks>
