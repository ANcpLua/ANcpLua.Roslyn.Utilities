...
///         </item>
///         <item>
///             <description>Supports glob patterns (e.g., <c>*.sln</c>) for flexible marker matching.</description>
///         </item>
///         <item>
///             <description>
///                 Provides implicit conversions to <see cref="FullPath" /> and <see cref="string" /> for
///                 convenience.
///             </description>
///         </item>
///         <item>
///             <description>Throws <see cref="DirectoryNotFoundException" /> when the repository root cannot be found.</description>
///         </item>
///     </list>
/// </remarks>
/// <example>
...
public readonly record struct RepositoryRoot
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Searches upward from <see cref="FullPath.CurrentDirectory" /> toward the file system root.</description>
    ///         </item>
    ///         <item>
    ///             <description>Glob patterns (containing <c>*</c>) are matched against files in each directory.</description>
    ///         </item>
    ///         <item>
    ///             <description>Non-glob markers are checked as both files and directories.</description>
    ///         </item>
    ///         <item>
    ///             <description>The first directory containing any matching marker is returned.</description>
    ///         </item>
    ///     </list>
    /// </remarks>
    /// <example>
    ...
    public static RepositoryRoot Locate(params string[] markerFiles)
    {
        ...
        while (true)
        {
            ...
            if (parent == directory)
                throw new DirectoryNotFoundException("Repository root not found. Searched for: " +
                                                     string.Join(", ", markerFiles));
            directory = parent;
        }
    }
