...
/// <remarks>
/// <list type="bullet">
/// <item><description>Use these constants when configuring test compilations with specific target frameworks.</description></item>
/// <item><description>TFM values follow the standard .NET naming conventions.</description></item>
/// <item><description>Includes both .NET Standard and modern .NET versions.</description></item>
/// </list>
/// </remarks>
...
public static class Tfm
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Maximum compatibility with .NET Framework 4.6.1+ and .NET Core 2.0+.</description></item>
    /// <item><description>Required for Roslyn analyzers and source generators.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Compatible with .NET Core 3.0+ and .NET 5+.</description></item>
    /// <item><description>Not compatible with .NET Framework.</description></item>
    /// </list>
    /// </remarks>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>Use these constants when reading or setting MSBuild properties via <c>AnalyzerConfigOptions</c>.</description></item>
/// <item><description>Property names are case-sensitive in MSBuild.</description></item>
/// <item><description>Covers project configuration, packaging, source link, and code analysis properties.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="Val"/>
/// <seealso cref="Item"/>
public static class Prop
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Values are semicolon-separated TFMs.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="Tfm"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>When enabled, package versions are defined in Directory.Packages.props.</description></item>
    /// <item><description>Project files use <see cref="Item.PackageReference"/> without Version attributes.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Enables Source Link path mapping for reproducible builds.</description></item>
    /// <item><description>Should be set to true only in CI pipelines.</description></item>
    /// </list>
    /// </remarks>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>Use these constants when setting MSBuild property values.</description></item>
/// <item><description>Boolean values use lowercase strings ("true"/"false") per MSBuild conventions.</description></item>
/// <item><description>Includes output types, boolean toggles, and special values.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="Prop"/>
public static class Val
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Uses the latest stable C# language version.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Enables preview C# language features.</description></item>
    /// <item><description>Preview features may change before final release.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="Prop.LangVersion"/>
    /// <seealso cref="Latest"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Portable PDB symbol package format.</description></item>
    /// <item><description>Recommended format for NuGet.org symbol server.</description></item>
    /// </list>
    /// </remarks>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>Use these constants when working with MSBuild item groups.</description></item>
/// <item><description>Item names are case-sensitive in MSBuild.</description></item>
/// <item><description>Covers package references, project references, and file items.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="Attr"/>
/// <seealso cref="Prop"/>
public static class Item
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Used in Directory.Packages.props files.</description></item>
    /// <item><description>Requires <see cref="Prop.ManagePackageVersionsCentrally"/> to be enabled.</description></item>
    /// </list>
    /// </remarks>
...
/// <remarks>
/// <list type="bullet">
/// <item><description>Use these constants when building or parsing MSBuild item metadata.</description></item>
/// <item><description>Attribute names are case-sensitive in MSBuild.</description></item>
/// <item><description>Covers item identity, versioning, asset control, and conditional attributes.</description></item>
/// </list>
/// </remarks>
/// <seealso cref="Item"/>
/// <seealso cref="Val"/>
public static class Attr
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Used with Central Package Management to override a specific package version.</description></item>
    /// <item><description>Takes precedence over versions defined in Directory.Packages.props.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Assets listed here are not consumed by dependent projects.</description></item>
    /// <item><description>Common values: "all", "none", or specific asset types.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Supports MSBuild condition expressions (e.g., "'$(Configuration)'=='Debug'").</description></item>
    /// <item><description>Can be applied to properties, items, and targets.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Used to tag PropertyGroups and ItemGroups for organizational purposes.</description></item>
    /// <item><description>Has no effect on build behavior.</description></item>
    /// </list>
    /// </remarks>
