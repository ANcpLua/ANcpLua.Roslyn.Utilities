...
/// </para>
/// <list type="bullet">
/// <item><description>Process exit code and console output</description></item>
/// <item><description>SARIF diagnostics file for structured error/warning analysis</description></item>
/// <item><description>Binary log content for detailed build introspection</description></item>
/// </list>
/// <para>
    ...
    byte[] BinaryLogContent)
{
    ...
    /// </summary>
    /// <param name="ruleId">The diagnostic rule ID to search for.</param>
    /// <returns><see langword="true"/> if an info diagnostic with the specified rule ID exists; otherwise, <see langword="false"/>.</returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description>"Compile" - Source files to compile</description></item>
    /// <item><description>"Reference" - Assembly references</description></item>
    /// <item><description>"PackageReference" - NuGet package references</description></item>
    /// <item><description>"Content" - Content files to include</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <returns><see langword="true"/> if the target was found and executed; <see langword="false"/> if not found or skipped.</returns>
    /// <remarks>
...
public class SarifFileRunResult
{
    ...
    /// <list type="bullet">
    /// <item><description>"error" - Compilation error</description></item>
    /// <item><description>"warning" - Compilation warning</description></item>
    /// <item><description>"note" - Informational message</description></item>
    /// <item><description>"none" - No severity specified</description></item>
    /// </list>
    /// </value>
    ...
    /// </summary>
    /// <value>The <see cref="SarifFileRunResultMessage"/> containing the diagnostic message, or <see langword="null"/> if not present.</value>
