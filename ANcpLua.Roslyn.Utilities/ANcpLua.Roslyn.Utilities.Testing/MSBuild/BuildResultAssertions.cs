...
/// </para>
/// <list type="bullet">
///     <item><description>Build success/failure validation</description></item>
///     <item><description>Warning and error detection by rule ID</description></item>
///     <item><description>Output content verification</description></item>
///     <item><description>MSBuild property value validation</description></item>
///     <item><description>MSBuild target execution verification</description></item>
/// </list>
/// </remarks>
/// <example>
/// <code>
...
public static class BuildResultAssertions
{
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Validates that <see cref="BuildResult.ExitCode"/> equals 0.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="BuildResult.Succeeded"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Validates that <see cref="BuildResult.ExitCode"/> is not 0.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="BuildResult.Failed"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Uses SARIF output to detect warnings by rule ID.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Uses SARIF output to verify absence of the warning.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="BuildResult.HasWarning(string)"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Uses SARIF output to detect errors by rule ID.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Uses SARIF output to verify absence of the error.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="BuildResult.HasError(string)"/>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Performs a case-sensitive ordinal comparison by default.</description></item>
    ///     <item><description>Searches across all lines of process output.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Extracts property values from the binary log.</description></item>
    ///     <item><description>Retrieves the last evaluated value of the property.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>
    /// <list type="bullet">
    ///     <item><description>Analyzes the binary log to determine target execution.</description></item>
    ///     <item><description>A target is considered executed if it was invoked and not skipped.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    ...
    /// <list type="bullet">
    ///     <item><description>Analyzes the binary log to determine target execution.</description></item>
    ///     <item><description>Passes if the target was either not invoked or was skipped.</description></item>
    ///     <item><description>On failure, includes the full process output in the assertion message.</description></item>
    /// </list>
    /// </remarks>
    /// <seealso cref="BuildResult.IsMsBuildTargetExecuted"/>
