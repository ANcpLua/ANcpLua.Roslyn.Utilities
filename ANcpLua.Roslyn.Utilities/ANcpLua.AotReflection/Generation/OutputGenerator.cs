...
internal static class OutputGenerator
{
    public static FileWithName GenerateOutput(TypeModel type)
    {
        ...
        sb.Append(GeneratedCodeHelpers.AutoGeneratedHeader("ANcpLua.Analyzers.AotReflection"));
        ...
        foreach (var declaration in type.DeclarationChain)
        {
            ...
            foreach (var clause in declaration.ConstraintClauses) sb.AppendLine(clause);
    ...
    {
        var typeName = string.Join("+", type.DeclarationChain.Select(static declaration => declaration.Name));
