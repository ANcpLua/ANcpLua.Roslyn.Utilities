...
internal static class PropertyCodeGenerator
{
    public static void WritePropertyMetadataArray(IndentedStringBuilder sb, TypeModel type)
    {
        ...
        {
            sb.AppendLine("Properties = global::System.Array.Empty<global::ANcpLua.AotReflection.PropertyMetadata>(),");
            return;
        }

        sb.AppendLine("Properties = new global::ANcpLua.AotReflection.PropertyMetadata[]");
        sb.BeginBlock();

        foreach (var property in type.Properties)
        {
            sb.AppendLine("new global::ANcpLua.AotReflection.PropertyMetadata");
            sb.BeginBlock();
